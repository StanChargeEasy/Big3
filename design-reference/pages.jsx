    ...
    <main className="b3-page">
      ...
      <div className="b3-shell">
        <div className="b3-offer-intro b3-measure">
          ...
          <h1 className="b3-band-title" style={{ color: 'var(--b3a-ink)', marginTop: '10px', maxWidth: '15ch', fontSize: "45px" }}>Your full natal reading — CHF 180</h1>
    ...
    <main className="b3-page">
      <div className="b3-shell">
        <div className="b3-offer-intro b3-measure" style={{ paddingTop: '34px' }}>
          ...
          <h1 className="b3-band-title" style={{ color: 'var(--b3a-ink)', marginTop: '10px', maxWidth: '16ch' }}>Not sure yet? Let's meet first — CHF 20</h1>
  ...
  return (
    <main className="b3-page">
      <div className="b3-shell">
        <div className="b3-offer-intro b3-measure" style={{ paddingTop: '34px' }}>
          <span className="b3-eyebrow">{t.nav.reading}</span>
          <h1 className="b3-band-title" style={{ color: 'var(--b3a-ink)', marginTop: '10px', maxWidth: '17ch' }}>Relationship &amp; couples reading — CHF 250</h1>
